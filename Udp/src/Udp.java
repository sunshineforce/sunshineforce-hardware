...
public class Udp {
    ...
    public String response(){
        ...
        try{
            ...
            int type = Integer.parseInt(Util.ByteToHex(typeByte), 16);
            if(type != 1){
                return "type error";
            }
            ...
            String dataStr = Util.ByteToHex(dataByte);
            ...
            for(int i = 0; i < num; i++){
                ...
                String wifiMac = Util.ByteToHex(wifiMacByte);
                ...
                int signal = Integer.parseInt(Util.ByteToHex(signalByte),16);
                ...
                String broadcastValue = Util.ByteToHex(broadcastValueByte);
    ...
    public boolean checkHeqader(byte[] header){
        System.out.println(Util.ByteToHex(header));
        return HEADER.equals(Util.ByteToHex(header).toUpperCase());
    }
    ...
    public String getData(byte[] broadcastValueByte){
        ...
        String uuid = Util.ByteToHex(uuidByte);
...
//        System.out.println("name:    "+name);
        ...
        int heartRate = Integer.parseInt(Util.ByteToHex(heartRateByte), 16);
        ...
        int diastolicPressure = Integer.parseInt(Util.ByteToHex(diastolicPressureByte),16);
        ...
        int systolicPressure = Integer.parseInt(Util.ByteToHex(systolicPressureByte),16);
        ...
        int staticHeartRate = Integer.parseInt(Util.ByteToHex(staticHeartRateByte),16);
